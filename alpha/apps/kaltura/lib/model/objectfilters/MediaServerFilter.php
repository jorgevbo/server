 ...
 */ 
class MediaServerFilter extends baseObjectFilter
{
	...
	public function describe() 
	{
		return 
			array (
				"display_name" => "MediaServerFilter",
				"desc" => ""
			);
	}
	...
	{
		$res = MediaServerPeer::translateFieldName( $field_name , $this->field_name_translation_type , BasePeer::TYPE_COLNAME );
		return $res;
	}

	public function getIdFromPeer (  )
	{
		return MediaServerPeer::ID;
	}
}
